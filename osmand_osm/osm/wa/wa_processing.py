...
# hold information for each county
class County:
...
target_list_county = ['king', 'snohomish', 'pierce', 'thurston', 'clark', 'spokane', 'whatcom', 'kitsap', 'cowlitz', 'franklin', 'skagit', 'grant']

id = shp2osm('king', 'king_co_addresses_trimmed3.shp', id_start)
...
if arg == 'update-state':
    os.system('curl --output washington-latest.osm.pbf https://download.geofabrik.de/north-america/us/washington-latest.osm.pbf')
os.system('osmium merge -Of pbf king_co_addresses.osm snohomish_co_addresses.osm pierce_co_addresses.osm thurston_co_addresses.osm clark_co_addresses.osm spokane_co_addresses.osm whatcom_co_addresses.osm kitsap_co_addresses.osm cowlitz_co_addresses.osm franklin_co_addresses.osm city_of_kennewick_addresses.osm skagit_co_addresses.osm grant_co_addresses.osm washington-latest.osm.pbf -o Us_washington_northamerica_improved.osm.pbf')
