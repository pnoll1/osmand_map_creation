...
def filterTags(attrs):
    if not attrs:
        return
    # raw variables
    address_number = 'HouseNumbe'
    suffix = ''
    #AddSfx 1/2 & B
    pre_dir_raw = 'DirPrefix'
    #prefix_raw = 'StPrefix' # HWY or AVE
    street_name_raw = 'FeatureNam'
    street_type_raw = 'FeatureTyp'
    post_dir_raw = 'DirSuffix' 
    city = '' # Muni, needs expansion
    #bldg_raw = 'PrUnitID'
    unit_raw = 'UnitNumber'
    postcode_raw = ''
    # processed variables
   ...
   #    prefix = translateName(attrs[prefix_raw])
    ...
    return tags
'''
Green Mountain Ext Road
48th street Court
130  could add Gassman Road manually
'''